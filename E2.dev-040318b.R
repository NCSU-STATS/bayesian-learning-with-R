...
samps <- bugs(data = stacks_dat, inits = mlr_inits,
              parameters.to.save = c("precision2"), 
              model.file = mlr_model2, 
              codaPkg = TRUE,
              n.chains = n.chains, n.burnin=1000, n.iter = nSamples,  DIC=F)#n.thin=10,
